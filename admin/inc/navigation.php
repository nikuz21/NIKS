              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-1">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=inmates" class="nav-link nav-inmates">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=visits" class="nav-link nav-visits">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=prisons" class="nav-link nav-prisons">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=cells" class="nav-link nav-cells">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=crimes" class="nav-link nav-crimes">
